...
const ProductCta = ({ product }) => {
  ...
  return (
    ...
    <div className='flex flex-col sm:flex-row items-center justify-between mt-12 gap-12 mb-12 flex-wrap'>
      ...
      <div className='border border-black w-full  max-w-[190px] h-16 uppercase font-bold flex items-center justify-between rounded-2xl text-color-gray-1 overflow-hidden'>
